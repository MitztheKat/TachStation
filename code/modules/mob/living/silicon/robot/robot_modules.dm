...
/obj/item/weapon/gripper/security
	...
	desc = "A simple grasping tool for interacting with security equipment, such as recorders, weapons (can't use them), magazines, armor and more. Alt click to drop instead of use."
	icon_state = "gripper"
	can_hold = list(
		/obj/item/gun,
